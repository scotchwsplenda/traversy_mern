...
<div>
    ...
    <ol><li>This website presents an opportunity to prognosticate on the scores of games in the upcoming NFL season. This exercise is called <a href="/guess">Guess</a>. </li>
    ...
    <li>Below is the grading rubric. The final grade is your combined performance on items (a) and (b). For example if your prognosticated game score was a 24-27 (OverUnder: 51, Spread: 3) loss and the actual game score was a 30-33 (OverUnder: 63, Spread: 3) loss your prognostication score would be 185:</li>
            <ul>
            <li> (a) OverUnder: 63-51=12 {'==>'} 85</li>
            <li> (b) Spread: 3-3=0 {'==>'} 100</li>
            </ul>   
            <li/> It is worth noting an incorrect guess on the outcome of the game (guessing a win when the team loses) results in a score of 0 for the spread
    </ul>
        </h2>
        <table class="table table-striped table-bordered border-primary">
